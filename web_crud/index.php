...
?>
        ...
        <tr>
            ...
            <a href="detail.php?detail=<?php echo $id ?>" class="btn btn-warning btn-sm" role="button">Detail</a></td>
        </tr>
<?php
    }
}  
...
?>
<p class="float-right">
            <a href="logcheck.php" class="btn btn-danger"><i class='fas fa-sign-out-alt'></i> Logout</a>
        </p>
    </table>
</div>
